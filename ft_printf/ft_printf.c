/*Assignment name : ft_printf
    ...
    free, write, va_start, va_arg, va_copy, va_end-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    -Vous devez gérer uniquement les conversions suivantes : s,
                                                             d et x - Vous devez gérer la taille de champ minimal.(Nous ne testerons jamais votre programme avec une taille de champ minimal de 0) - Vous devez gérer uniquement le flag de précision `.`.

                                                                                                                                                                                                     Votre fonction devra être prototypée de la façon suivante :

    int ft_printf(const char *, ...);

Avant de commencer nous vous conseillons la lecture du `man 3 printf` et du `man va_arg`.Nous vous recommandons de tester votre programme en le comparant avec le vrai printf.
